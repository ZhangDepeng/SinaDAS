    ...
    function(declare,lang,parser,query, dom,BaseWidget, Query, QueryTask, topic,WidgetManager,event, on, FeatureSet, Geoprocessor,
        ...
        return declare([BaseWidget], {
            ...
            startGp: function(checkindate, name, groupnum) {
                ...
                var dataname = name;
                var gp = new Geoprocessor("http://localhost:6080/arcgis/rest/services/SinaAnalysis/Kmearngroup/GPServer/Kmearngroup");
                ...
                getuserPoi.then(function(response) {
                    ...
                    var URL = "http://localhost:6080/arcgis/rest/services/sinaData/sina/FeatureServer/0";
            ...
            changeDeploy: function() {
                ...
                var DeployArea = new FeatureLayer("http://localhost:6080/arcgis/rest/services/sinaData/sinadata/FeatureServer/3", {
            ...
            activeRegisonGp:function(ID,layerid,date){
                ...
                var gp=new Geoprocessor("http://localhost:6080/arcgis/rest/services/SinaAnalysis/activeRegion/GPServer/activeRegion");
            ...
            startRoadGp: function(linedate, roadmap, allroadmap) {
                ...
                var queryTask;
                if (roadmap) {
                    gp = new Geoprocessor("http://localhost:6080/arcgis/rest/services/SinaAnalysis/road/GPServer/road");
                    dataname = 'roadmap';
                    query = new Query();
                    query.returnGeometry = true;
                    ...
                    queryTask = new QueryTask('http://localhost:6080/arcgis/rest/services/sinaData/sinadata/FeatureServer/0');
                    queryTask.execute(query, function(res) {
                        road = res.features;
                    });
                } else if (allroadmap) {
                    gp = new Geoprocessor("http://localhost:6080/arcgis/rest/services/SinaAnalysis/allroad/GPServer/allroad");
                    dataname = 'allroadmap';
                    query = new Query();
                    query.returnGeometry = true;
                    query.outFields = ["widthroad"];
                    query.where = "1=1";
                    queryTask = new QueryTask('http://localhost:6080/arcgis/rest/services/sinaData/sinadata/FeatureServer/1');
                    queryTask.execute(query, function(res) {
                        road = res.features;
                    });
                }
            ...
            startHourGp: function(Description,Layernum,hourdate,starthour,endhour) {
                ...
                getuserPoi.then(function(response) {
                    ...
                    queryTask.execute(query, function(res) {
                        ...
                        featureSet.features = feature;
                        var road;
                        this.gp = new Geoprocessor("http://localhost:6080/arcgis/rest/services/SinaAnalysis/road/GPServer/road");
                        query = new Query();
                        query.returnGeometry = true;
                        query.outFields = ["FID_beijin"];
                        query.where = "1=1";
            ...
            POIimClick:function(){
                ...
                var gp = new Geoprocessor("http://localhost:6080/arcgis/rest/services/SinaAnalysis/poiimport/GPServer/poiimport");
                gp.setOutputSpatialReference({
                    wkid: 102100
                });
                ...
                var query = new Query();
                    ...
                    query.where = "1=1";
                    var URL = "http://localhost:6080/arcgis/rest/services/sinaData/sina/FeatureServer/4";
                    var queryTask = new QueryTask(URL);
                    console.log("11");
                    queryTask.execute(query, function(res) {
                        console.log(res);
                        ...
                        getuserPoi.then(function(response) {
                            ...
                            // console.log(sql);
                            query.where=sql;
                            var URL = "http://localhost:6080/arcgis/rest/services/sinaData/sina/FeatureServer/1";
                            var queryTask = new QueryTask(URL);
                            // var layer=self.map.getLayer("poiPoint"); 
                            // layer.queryFeatures
                            queryTask.execute(query, function(res) {
            ...
            getLandmark:function(){
                ...
                if(GpResultLayer1!==null){
                    ...
                    var gp = new Geoprocessor("http://localhost:6080/arcgis/rest/services/SinaAnalysis/poivoronoi/GPServer/poivoronoi");
                    gp.setOutputSpatialReference({
                        wkid: 102100
                    });
                    var params = {
