...
define([
    ...
    function(declare, parser, BaseWidget,on,QueryTask,Query,SimpleFillSymbol,SimpleLineSymbol,
        ...
        return declare([BaseWidget], {
            ...
            selectTWOv:'',
            AnalysisArea:null,
            serverurl:'http://localhost:6080/arcgis/rest/services/',
            postCreate: function() {
            ...
            startSearch : function() {
                ...
                if (isRadioOne) {
                    ...
                    areaDraw.deactivate();  
                    var url=self.serverurl+"sinaData/sina/FeatureServer/2";
                    ...
                    url=self.serverurl+"sinaData/sina/FeatureServer/4";
