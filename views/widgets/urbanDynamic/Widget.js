    ...
    function(declare,lang,parser,BaseWidget,on,query,dom,domConstruct,WidgetManager,topic,HorizontalSlider,
        ...
        return declare([BaseWidget], {
            ...
            urbanTotalGp:function(ID,layerID,checkindate) { 
                ...
                gp=new Geoprocessor("http://localhost:6080/arcgis/rest/services/sinaAnalysis/DensityEstimation/GPServer/DensityEstimation");
            ...
            startGridGp:function(description,LayerNum,dStartDate,dStartTime,dEndTime){
                ...
                var gp=new Geoprocessor("http://localhost:6080/arcgis/rest/services/sinaAnalysis/HridThematicMap/GPServer/HridThematicMap");
                gp.setOutputSpatialReference({wkid:102100});
