            ...
            GetFlows:function(){
                ...
                ajaxDreturn.then(function(response){
                    ...
                    for(var i=0;i<flowJson.length ;i++){
                        var queryTaska= new QueryTask("http://localhost:6080/arcgis/rest/services/sinaData/sina/FeatureServer/0");
                        ...
                        queryTaska.execute(querya,function(resp){
                            console.log(len);
                            var SimpleLine = new SimpleLineSymbol("solid", new Color([0,191,255,1]),1); 
