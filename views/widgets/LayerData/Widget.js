    ...
    function(declare, lang, BaseWidget,arrayUtils,QueryTask,Color,Query,ClusterFeatureLayer,SimpleMarkerSymbol,
        ...
        var clazz = declare([BaseWidget], {
            ...
            queryFeature:function(){
                ...
                var queryTask = new QueryTask("http://localhost:6080/arcgis/rest/services/sinaData/sina/FeatureServer/0");  
                var query = new Query();  
            ...
            showpoint:function(){
                ...
                //添加user FeatureLayer
                url="http://localhost:6080/arcgis/rest/services/sinaData/sina/FeatureServer/1";
